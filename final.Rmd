...
lm_accuracy_df = data.frame(lm = c('accuracy'),ori_accuracy = c(lm_aver_accuracy),
...
Ridge_sqrt_aver_lambda
par(mfrow=c(2,2))
plot(Ridge.ori.Fitcv)
plot(Ridge.log.Fitcv)
plot(Ridge.sqrt.Fitcv)
par(mfrow = c(1,1))
```
...
printf("Accuracy of Lasso is approximately %.2f%%", Lasso_log_aver_accuracy*100)
# log accuracy
Lasso_log_accuracy
Lasso_log_aver_accuracy = mean(Lasso_log_accuracy)
