...
```{r lrlog}
lm_log_model = lm(formula = SalePrice ~.,data = train_log)
...
lm_log_accuracy = mean(abs(exp(y_test_log) - lm_log_pred /exp(y_test_log))<=0.05)
printf("We have the accuracy of the model approximately %.2f%%", lm_log_accuracy*100)
#lm_pred  = exp(lm_pred)
